...
import 'ward_notifcation_select_model.dart';
export 'ward_notifcation_select_model.dart';

class WardNotifcationSelectWidget extends StatefulWidget {
  const WardNotifcationSelectWidget({super.key});

  static String routeName = 'WardNotifcationSelect';
  static String routePath = '/wardNotifcationSelect';

  @override
  State<WardNotifcationSelectWidget> createState() =>
      _WardNotifcationSelectWidgetState();
}

class _WardNotifcationSelectWidgetState
    extends State<WardNotifcationSelectWidget> with TickerProviderStateMixin {
  late WardNotifcationSelectModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WardNotifcationSelectModel());

          ...
          child: Column(
            ...
            children: [
              Column(
                mainAxisSize: MainAxisSize.max,
                children: [
                  StreamBuilder<List<DailyAveragesRecord>>(
                    stream: queryDailyAveragesRecord(
                      queryBuilder: (dailyAveragesRecord) => dailyAveragesRecord
                          .where(
                            'date',
                            isGreaterThanOrEqualTo: functions
                                .getMonthStartDate(_model.selectedChartMonth),
                          )
                          .where(
                            'date',
                            isLessThanOrEqualTo: functions
                                .getMonthEndDate(_model.selectedChartMonth),
                          )
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<DailyAveragesRecord>
                          containerDailyAveragesRecordList = snapshot.data!;

                      return Container(
                        width: double.infinity,
                        decoration: BoxDecoration(),
                        child: Visibility(
                          visible: containerDailyAveragesRecordList.length > 0,
                          child: Padding(
                                          ...
                                          Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                ...
                                                _model.selectedChartMonth =
                                                    _model.datePicked1;
                                                safeSetState(() {});
                                              },
                                              text: valueOrDefault<String>(
                                                functions.getDisplayMonthName(
                                                    _model.selectedChartMonth),
                                                'Month',
                                              ),
                                      ...
                                      Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: FlutterFlowLineChart(
                                            data: [
                                              FFLineChartData(
                                                xData: functions.getChartDates(
                                                    containerDailyAveragesRecordList
                                                        .toList(),
                                                    _model.selectedChartMonth),
                                                yData: functions.getChartValues(
                                                    containerDailyAveragesRecordList
                                                        .toList(),
                                                    _model.selectedChartMonth),
                                          ...
                                          children: [
                                            Text(
                                              valueOrDefault<String>(
                                                formatNumber(
                                                  functions.calculateMonthlyAverage(
                                                      containerDailyAveragesRecordList
                                                          .toList()),
                                                  formatType:
                                                      FormatType.decimal,
                            ...
                            SingleChildScrollView(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  StreamBuilder<List<StatisticArchiveRecord>>(
                                    stream: queryStatisticArchiveRecord(
                                      queryBuilder: (statisticArchiveRecord) =>
                                          statisticArchiveRecord
                                              .where(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<StatisticArchiveRecord>
                                          listViewStatisticArchiveRecordList =
                                          snapshot.data!;
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemBuilder: (context, listViewIndex) {
                                          final listViewStatisticArchiveRecord =
                                              listViewStatisticArchiveRecordList[
                                                  listViewIndex];
                                          return Padding(
                                            padding:
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Align(
                                                            ...
                                                            child: Text(
                                                              valueOrDefault<
                                                                  String>(
                                                                listViewStatisticArchiveRecord
                                                                    .locationName,
                                                                'Wad 1',
                                                              ),
                                                              style: FlutterFlowTheme

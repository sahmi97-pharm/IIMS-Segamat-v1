...
import 'ward_form_status_model.dart';
export 'ward_form_status_model.dart';

class WardFormStatusWidget extends StatefulWidget {
  const WardFormStatusWidget({
    super.key,
  ...
  @override
  State<WardFormStatusWidget> createState() => _WardFormStatusWidgetState();
}

class _WardFormStatusWidgetState extends State<WardFormStatusWidget>
    with TickerProviderStateMixin {
  late WardFormStatusModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WardFormStatusModel());
    ...
    _model.switchValue3 = widget.locationRecord!.tdkFSUCoolbox;
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (widget.locationRecord?.type == 'Ward')
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            10.0, 10.0, 10.0, 10.0),
                        child: Material(
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Switch.adaptive(
                                          value: _model.switchFSUFValue!,
                                          onChanged: (newValue) async {
                                            safeSetState(() => _model
                                                .switchFSUFValue = newValue);
                                            if (newValue) {
                                              await widget
                                                  .locationRecord!.reference
                                                  .update(
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          15.0, 0.0, 15.0, 0.0),
                                      child: Text(
                                        'Sila tanda jika perlu, JIKA WAD/UNIT  TIDAK BAWA BERSAMA TROLI',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inter(
                                ...
                                children: [
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Switch.adaptive(
                                          ...
                                          onChanged: (_model.switchFIVDCValue ==
                                                  true)
                                              ? null
                                              : (newValue) async {
                                                  safeSetState(() =>
                                  ...
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(
                                          color: _model.switchFIVDCValue == true
                                              ? Color(0xFF18BAAD)
                                              : FlutterFlowTheme.of(context)
                                                  .secondaryBackground,
                                          borderRadius:
                                ...
                                children: [
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Switch.adaptive(
                                          ...
                                          onChanged: (_model.switchFDDCValue ==
                                                  true)
                                              ? null
                                              : (newValue) async {
                                                  safeSetState(() =>
                                  ...
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(
                                          color: _model.switchFDDCValue == true
                                              ? Color(0xFF18BAAD)
                                              : FlutterFlowTheme.of(context)
                                                  .secondaryBackground,
                                          borderRadius:

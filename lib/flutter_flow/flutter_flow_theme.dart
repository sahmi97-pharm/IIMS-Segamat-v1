...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF3B49D5);
  late Color secondary = const Color(0xFFFA7FAB);
  late Color tertiary = const Color(0xFF60E2FD);
  late Color alternate = const Color(0xFFE0E0F7);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF7E8EFD);
  late Color accent2 = const Color(0xFF5E70FF);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xFFB4BBF2);
